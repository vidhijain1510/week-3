...
class Library {
    ...
    public void searchByTitleOrAuthor(String title, String author) {//Searching book by Title/Author
        BookNode current = head;
        boolean found = false;
        while (current != null) {
    ...
    public void displayForward() {//Displaying books in forward
        BookNode current = head;
    ...
    public void displayReverse() {//Displaying books in reverse
    ...
    public int countBooks() {//Counting total books
        return totalBooks;
    }
